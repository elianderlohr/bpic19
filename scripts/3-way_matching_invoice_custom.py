...
print()
res = rc.make_throughout_analysis(log, "Record Invoice Receipt", "Clear Invoice", "export")
print("   From %s to %s" % (res["first"], res["second"]))
print("   Avg: %f, Median: %f, Standard deviation: %f, Var: %f" % res["throughput"])
print()
res = rc.make_throughout_analysis(log, "Record Goods Receipt", "Record Invoice Receipt", "export")
print("   From %s to %s" % (res["first"], res["second"]))
print("   Avg: %f, Median: %f, Standard deviation: %f, Var: %f" % res["throughput"])
print()
res = rc.make_throughout_analysis(log, "Record Goods Receipt", "Clear Invoice", "export")
print("   From %s to %s" % (res["first"], res["second"]))
print("   Avg: %f, Median: %f, Standard deviation: %f, Var: %f" % res["throughput"])
print()
res = rc.make_throughout_analysis(log, "Create Purchase Order Item", "Record Goods Receipt", "export")
print("   From %s to %s" % (res["first"], res["second"]))
print("   Avg: %f, Median: %f, Standard deviation: %f, Var: %f" % res["throughput"])
print()
